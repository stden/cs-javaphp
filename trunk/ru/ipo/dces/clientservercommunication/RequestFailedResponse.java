...
public class RequestFailedResponse implements InfoFrame {
    public int failReason; //0 - контест еще не начался, если пытаешься подключится
                           //1 - контест уже кончился, при попытке подключиться
                           //2 - логин или пароль не соответствуют, при подключении. И т.п.
                           //и т.д.
    public String message; //в сообщении можно дать дополнительную информацию об ошибке. Например,
