...
public class BinToBeanConverter {
    ...
    private static String HEADER = "This bean was automatically generated by Bin to Bean converter\n"
    ...
    public void convert(Class<?> c) throws FileNotFoundException {
    ...
    private void outputGetLayoutMethod(PrintStream out, Field[] publicFields) {
        ...
        for (int i = 0; i < publicFields.length; i++) {
            ...
            outputFieldEditor(out, INDENT + INDENT + INDENT, field, i == publicFields.length - 1);
        }
