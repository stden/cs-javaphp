...
public class ContestDescription {
  // TODO: подумать, не заменить ли int на Integer, чтобы задавать дефолтовое
  // значение через null, а не -1
  ...
  // 1 - видимый
  // -1 - значение не установлено
  public int      visible;         // контесты во время настройки не должны
                                    // быть
