Чтобы упростить процесс отладки серверного плагина, в DCES\_API имеется класс ServerPluginProxy. С его помощью можно автоматически перезаливать файл с плагином на сервер, создавать на сервере задачу, в которой будет происходить отладка и т.п.

# Отладка #

Реализуйте серверный плагин, см. стр. [ServerPluginImplementation](ServerPluginImplementation.md) для подробностей.
