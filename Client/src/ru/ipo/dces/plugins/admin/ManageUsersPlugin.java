...
public class ManageUsersPlugin extends JPanel implements Plugin {
  ...
  private void fillDaFormWithData(int contestID, String[] keys) {
    ...
    private void $$$setupUI$$$() {
        createUIComponents();
        drawPanel.setLayout(new FormLayout("fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:130dlu:grow(3.0),left:4dlu:noGrow,fill:1dlu:noGrow,left:4dlu:noGrow,fill:100dlu:grow(4.0),left:4dlu:noGrow,left:90dlu:grow,fill:max(d;4px):noGrow,fill:max(d;4px):noGrow", "center:max(d;4px):noGrow,top:4dlu:noGrow,center:16dlu:noGrow,top:4dlu:noGrow,center:16dlu:noGrow,top:4dlu:noGrow,center:16dlu:noGrow,top:4dlu:noGrow,center:84dlu:grow,top:4dlu:noGrow,top:1dlu:noGrow,center:4dlu:noGrow,top:16dlu:noGrow,top:4dlu:noGrow,center:16dlu:noGrow,top:4dlu:noGrow,center:16dlu:noGrow,top:4dlu:noGrow,center:0dlu:grow,center:max(d;4px):noGrow,top:16dlu:noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
        ...
        drawPanel.add(separator1, cc.xywh(5, 3, 1, 19, CellConstraints.FILL, CellConstraints.FILL));
        final JScrollPane scrollPane1 = new JScrollPane();
        drawPanel.add(scrollPane1, cc.xywh(7, 5, 1, 5, CellConstraints.FILL, CellConstraints.FILL));
        usersList = new JList();
        scrollPane1.setViewportView(usersList);
        final JSeparator separator2 = new JSeparator();
        drawPanel.add(separator2, cc.xyw(7, 11, 3, CellConstraints.FILL, CellConstraints.FILL));
        final JScrollPane scrollPane2 = new JScrollPane();
        drawPanel.add(scrollPane2, cc.xywh(7, 13, 1, 7, CellConstraints.FILL, CellConstraints.FILL));
        ...
        drawPanel.add(changeButton, cc.xyw(7, 21, 3));
        final JScrollPane scrollPane3 = new JScrollPane();
        drawPanel.add(scrollPane3, cc.xywh(3, 5, 1, 17, CellConstraints.FILL, CellConstraints.FILL));
